...
\runsubsection{Delphi ("TinyEvals")}
\descript{ | github.com/delphi-suite/delphi}
\location{2024 - Present: Evals Technical Lead}
\begin{tightemize}
...
\runsubsection{Rational Animations}
\descript{ | Scriptwriting}
